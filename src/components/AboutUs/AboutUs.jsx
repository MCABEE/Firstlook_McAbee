...
const AboutUs = () => {
    return (
        <>
            <p className="flex justify-center mt-10 text-[24px] text-[#727272] font-oxygen font-bold">
                About Firstlook
            </p>
            <p className="flex justify-center mt-4 text-[36px] font-oxygen font-bold text-center">
                a group of people <br />
                who love’s ‘Firstlook’ the most.
            </p>
            <p className="flex justify-center mt-4 text-[21px] text-center">
                Our mission is to connect people who are planning to marry or wish to find life partner. <br />
            ...
            <p className="flex justify-center mt-4 text-[21px] text-justify px-80">
            ...
            <div className="flex justify-center">
                <button className="mt-10 px-28 py-2 rounded-lg font-semibold bg-[#C8E9A0] text-[14px]">
                    DOWLOAD MEDIA KIT FOR MORE DETAILS
                </button>
            </div>

            <p className="flex justify-center text-[36px] font-oxygen font-bold text-center mt-16">
                Our Community
            </p>
            <div className="flex flex-col justify-center items-center h-full py-10 duration-300 sm:items-stretch space-x-8 sm:flex-row">
                <div className="px-10 py-5 text-center rounded-lg bg-[#472C4C] text-white">
                    <h6 className="font-bold text-[36px]">
                        2021
                    </h6>
                    <p className="text-center md:text-[21px]">
                        Born in
                    </p>
                </div>
                <div className="px-10 py-5 text-center rounded-lg bg-[#C8E9A0] text-[#472C4C]">
                    <h6 className="font-bold text-[36px]">
                        18
                    </h6>
                    <p className="text-center md:text-[21px]">
                ...
                <div className="px-10 py-5 text-center rounded-lg bg-[#77867F] text-white">
                    <h6 className="font-bold text-[36px]">
                        $0
                    </h6>
                    <p className="text-center md:text-[21px]">
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-0">
                <div className="grid row-gap-8 sm:grid-cols-5">
                    <div className="text-center">
                        <h6 className="text-[36px] font-bold">18</h6>
                        <p className="text-[#525252] text-[21px]">COUNTRIES</p>
                    </div>
                    <div className="text-center">
                        <h6 className="text-[36px] font-bold">24k</h6>
                        <p className="text-[#525252] text-[21px]">USERS</p>
                    </div>
                    <div className="text-center">
                        <h6 className="text-[36px] font-bold">72k</h6>
                        <p className="text-[#525252] text-[21px]">PHOTO’S</p>
                    </div>
                    <div className="text-center">
                        <h6 className="text-[36px] font-bold">18k</h6>
                        <p className="text-[#525252] text-[21px]">VIDEO’S</p>
                    </div>
                    <div className="text-center">
                        <h6 className="text-[36px] font-bold">100K</h6>
                        <p className="text-[#525252] text-[21px]">PROPOSAL’S</p>
                    </div>
                </div>
            </div>
            ...
            <p className="flex justify-center mt-4 text-[21px] text-center px-80">
                The social network ‘Firstlook’ owned by ‘MCABEE’ a Chennai based company and it was the trade name of ‘Sebastian and Sons Digital Pvt Ltd’. It is an IT company registered under the companies act, under Govt. of India in 2021. The company is familiar in it’s trade name ‘MCABEE’.
                It’s a technology company is SaaS category.
            ...
            <p className="flex justify-center mt-4 text-[21px] text-center px-72">
            ...
            <p className="flex justify-center mt-12 mb-10 text-[24px] text-center font-bold">
