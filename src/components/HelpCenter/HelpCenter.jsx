    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center">
                ...
                <section className="text-gray-800">
                    <div className="container flex flex-col justify-center items-center p-4 mx-auto md:p-8">
                        <div className="grid gap-10 md:gap-8 sm:p-3 md:grid-cols-2 2xl:px-32">
                            <div>
                                <p className="text-[48px] font-bold font-oxygen">
                                    Help Centre
                                </p>
                                <p className="text-[16px] text-[#545454] sm:w-3/5">
                                    See, what’s new from Firstlook.
                                    News and updates from us.
                                </p>
                            </div>
                            <div>
                                <p className="text-[21px] mt-6">
                                    How can we help you?
                                </p>
                                <form>
                                    <div className="flex mt-5">
                                        ...
                                        <input type="text" className="sm:w-[32vw] rounded-bl-md rounded-tl-md border border-[#DDDCDC] bg-[#DDDCDC] px-8" />
                                        <button type='submit'
                                            className="sm:ml-1 w-1/4 bg-[#FC4055] cursor-pointer rounded-br-md rounded-tr-md sm:px-6 px-3 py-2 text-[14px] text-white transition-none"
                                        >
                                            EXPLORE
                                        </button>
                                    </div>
                ...
                <hr className='mt-10 border-gray-300 border-1 w-5/6 mx-auto' />
                ...
                <hr className=' border-gray-300 border-1 w-5/6 mx-auto' />
                ...
                <section className=" text-gray-800">
                    <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
                        <div className="grid gap-10 lg:gap-96 sm:p-3 md:grid-cols-2 2xl:px-32">
                                ...
                                <div className="lg:w-[42rem] w-full mt-10">
                                    <div>
                                        <button onClick={() => setIsOpen((prev) => (prev === "q1" ? "" : "q1"))} className="flex items-center focus:outline-none">
                                            ...
                                            <h1 className="mx-4 text-[18px] text-gray-700">How can I pay for my appointment ?</h1>
                                        </button>
                                    ...
                                    <div>
                                        <button onClick={() => setIsOpen((prev) => (prev === "q2" ? "" : "q2"))} className="flex items-center focus:outline-none">
                                            ...
                                            <h1 className="mx-4 text-[18px] text-gray-700">What can I expect at my first consultation ?</h1>
                                        </button>
                                    ...
                                    <div>
                                        <button onClick={() => setIsOpen((prev) => (prev === "q3" ? "" : "q3"))} className="flex items-center focus:outline-none">
                                            ...
                                            <h1 className="mx-4 text-[18px] text-gray-700">What are your opening hours ?</h1>
                                        </button>
                                    ...
                                    <div>
                                        <button onClick={() => setIsOpen((prev) => (prev === "q4" ? "" : "q4"))} className="flex items-center focus:outline-none">
                                            ...
                                            <h1 className="mx-4 text-[18px] text-gray-700">Do I need a referral ?</h1>
                                        </button>
                                    ...
                                    <div>
                                        <button onClick={() => setIsOpen((prev) => (prev === "q5" ? "" : "q5"))} className="flex items-center focus:outline-none">
                                            ...
                                            <h1 className="mx-4 text-[18px] text-gray-700">Is the cost of the appointment covered by private health insurance ?</h1>
                                        </button>
                            ...
                            <div>
                                <button className="inline-flex items-center py-2 mt-8 space-x-2 bg-[#FC3657] text-[12px] px-6 rounded-md text-white transform transition hover:scale-95 duration-300 ease-in-out">
                                    TOP ARTICLES
                                </button>
                                <div className="rounded w-full flex flex-col mb-3 md:mb-10 items-start">
                                    <div className="text-gray-800 font-semibold text-[21px] mt-6 mb-5">
                                        Android version of ‘Firstlook’ released today.
                                    </div>
                                    <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" className="block md:hidden lg:block rounded-md h-44 m-4 md:m-0" />
                                ...
                                <div className="rounded w-full flex flex-col mb-3 md:mb-10 items-start">
                                    ...
                                    <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" className="block md:hidden lg:block rounded-md h-44 m-4 md:m-0" />
                                    <div className="bg-white rounded mt-5">
                                        <p className="p-2 pl-0 pt-1 text-[14px] text-gray-600">
                                            Launched ‘Firstlook’ a social netwrok for singles to find life partner. The web version is now introduced in India in the domain called www.firstlok.pro
                                        </p>
                                    </div>
                                </div>
