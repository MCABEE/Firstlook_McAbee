                        ...
                        <motion.div
                            ...
                            <div className="flex flex-wrap">
                                <button
                                    className={
                                        isHovered1
                                            ? "mt-4 h-[75px] w-[75px] flex justify-center items-center rounded-lg"
                                            : "mt-4 border border-gray-400 h-[75px] w-[75px] flex justify-center items-center rounded-lg"
                                    }
                                ...
                                <button
                                    className={
                                        isHovered2
                                            ? "mt-4 h-[75px] w-[75px] flex justify-center items-center rounded-lg ml-4"
                                            : "mt-4 border border-gray-400 h-[75px] w-[75px] flex justify-center items-center rounded-lg ml-4"
                                    }
                                ...
                                >
                                    {isHovered2 ? (
                                        <button
                                            className="h-[75px] w-[75px] flex justify-center items-center rounded-lg bg-gradient-to-r from-[#FF944E] to-[#FC3158]"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="11"
