    ...
    return (
        <>
            <div className="relative w-full h-full bg-no-repeat bg-cover lg:bg-bg_pay">
                ...
                <div className="relative px-10 sm:px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        <motion.h2
                            initial={{ y: "-10vw", opacity: 0 }}
                            whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
                            viewport={{ once: true, amount: 0.8 }}
                            className="max-w-lg mb-6 font-sans text-[25px] text-center font-bold leading-none tracking-tight text-gray-900 sm:text-[42px] md:mx-auto">
                            <span className="relative inline-block">
                                <svg
                                    viewBox="0 0 52 24"
                                    fill="currentColor"
                                    className="absolute top-0 left-0 z-0 w-32 -mt-8 -ml-20 text-gray-400 lg:w-32 lg:-ml-28 lg:-mt-10"
                                >
                                    <defs>
                                        <pattern
                        ...
                        <motion.p
                            ...
                            whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
                            viewport={{ once: true, amount: 0.8 }}
                            className="text-gray-700 text-[15px] text-justify">
                            We introduce the first unlimited package and pay-per-use plan in the segment !
                        </motion.p>
                    </div>
                    <div className="sm:grid gap-10 lg:grid-cols-3 mt-20 sm:mx-auto hidden">
                        <motion.div
                            initial={{ y: "-10vw", opacity: 0 }}
                            whileInView={{ y: 1, opacity: 1, transition: { type: "spring", stiffness: 50, delay: 0.2 } }}
                            viewport={{ once: true, amount: 0.8 }}
                    ...
                    <div className="mt-20 sm:hidden flex overflow-x-scroll hide-scroll-bar w-screen">
                        <div className='mr-16'>
                            <div className="w-6/12 h-8 bg-red-500 rounded-t-xl">
                                <p className="text-base h-full flex justify-center items-center font-oxygen text-white">
                                    Standard Plan
                            ...
                            <div className="w-96 p-8 bg-white border-2 lg:shadow-sm rounded-b-xl rounded-tr-xl">
                                <div className="text-start">
