        ...
        <>
            <footer aria-label="Site Footer" class="bg-white">
                <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    <div
                        class="flex flex-col items-center gap-4 rounded-lg bg-gradient-to-b from-orange-500 to-rose-600 p-6 shadow-lg sm:flex-row sm:justify-between"
                    >
                        <strong class="text-xl text-white sm:text-xl">
                            Experience the easyness of quick signup !
                        </strong>

                        <a
                            class="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-rose-600 hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
                            href="/"
                        >
                    ...
                    <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        <div class="text-center sm:text-left">
                            <p class="text-lg font-medium text-gray-900">Country</p>
                            ...
                            <nav aria-label="Footer About Nav" class="mt-16">
                                ...
                                <div>
                                    <select
                                        ...
                                        className="block w-56 mx-auto sm:w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                                    >
                                        <option>India</option>
                                    </select>
                                </div>
                    ...
                    <div class="mt-16">
                        ...
                        <div class="mt-16 sm:flex sm:items-center sm:justify-between">
                            ...
                            <p class="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-right">
                                Copyright &copy; Firstlook 2023. All rights reserved.
                            </p>
                        </div>
                    </div>
                </div>
