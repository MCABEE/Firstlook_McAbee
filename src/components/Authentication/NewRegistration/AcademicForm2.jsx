...
const AcademicForm2 = () => {
  ...
  const handleData = async (e) => {
    ...
    if (academicStream === '') {
      ...
      await saveEducation(academicStream)
        .then(() => {
    ...
    <>
        ...
        <div>
          <div className="relative right-10">
            ...
            <div className="absolute top-0 left-5 w-64 -ml-20">
              <p className="text-[21px] font-semibold text-center">What is your <br />
                current field of study ?</p>
            </div>
          </div>
        </div>
      </div>
      <div className="flex justify-center mt-8">
        <p className="text-[12px]">
          Provide your pursuing academic stream
        </p>
      </div>
      <form className="w-72 ml-3.5 sm:ml-12" onSubmit={handleData}>
        <div className="mb-8 mt-8 flex">
          ...
          >
            <p className="w-48 mt-3 ml-2 truncate text-sm">{academicStream ? academicStream : "Choose your academic stream"}</p>
          </div>
          ...
          {isOpen === 'Academic Stream' ? (
            <ul className="absolute z-10 w-72 mt-14 h-56 overflow-y-scroll bg-white border border-[#B8B8B8] rounded-lg shadow-lg">
              ...
              >
                <p className="mr-2 font-semibold">Choose your academic stream</p>
              </li>
